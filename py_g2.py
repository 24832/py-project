...
# set the variables for pF function for soil type 1
soilType = "1"
...
for Theta in VWC_3_9:
    entry=get_pF(Theta, alpha, Thetar, Thetas, nSoil)
    soil_pF.append(entry)
# print (soil_pF)

# set the variables for pF function for soil type 2
soilType = "2"
alpha = float(soils[soilType]['alpha'])
Thetar = float(soils[soilType]['thetar'])
Thetas = float(soils[soilType]['thetas'])
...
# set the variables for pF function for soil type 3
soilType = "3"
alpha = float(soils[soilType]['alpha'])
Thetar = float(soils[soilType]['thetar'])
Thetas = float(soils[soilType]['thetas'])
...
# set the variables for pF function for soil type 4
soilType = "4"
alpha = float(soils[soilType]['alpha'])
Thetar = float(soils[soilType]['thetar'])
Thetas = float(soils[soilType]['thetas'])
...
# set the variables for pF function for soil type 5
soilType = "5"
alpha = float(soils[soilType]['alpha'])
Thetar = float(soils[soilType]['thetar'])
Thetas = float(soils[soilType]['thetas'])
